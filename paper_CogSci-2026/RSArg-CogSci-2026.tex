...
Finally, we observe a much higher frequency of `none : all : right' than predicted by any model. This utterance is chosen in both frame conditions. For example, in the high frame condition, it is chosen for exam results where all students got all answers wrong.\fc{tofinish}
