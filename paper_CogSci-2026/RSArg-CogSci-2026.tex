...
- To calculate argstrength in this case, we need to calculate $p(\text{utterance being true} \mid \text{argued-for state} ) = \sum_{s \in \textrm{observations}} I(s \in \textrm{utterance}) p(s \mid \text{argued-for state})$.
