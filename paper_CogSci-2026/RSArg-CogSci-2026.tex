...
The design used here is essentially the same as that of Experiment~1 reported in \cite{Vinicius-Macuch-SilvaWinter2024:Strategic-use-o}, except that we here used a larger set of visual scenes (different array sizes, see below).
...
\paragraph{Materials.}
The results of high-school exams were presented visually in form of matrices, as shown in Figure~\ref{fig:example-picture}.
...
The results were always arranged to show students ordered in terms of performance (students with more correct answers on in higher rows).
