...
One systematic way the two depart is that the mf-argstrength model systematically postdicts higher frequency than the maximin-argstrength model for `all : some : right' in the high condition and `all : some : wrong' in the low condition. 
Another is that mf-argstrength systematically postdicts lower frequency than maximin-argstrength for `some : most : wrong' in the low condition and `some : most : right' in the high condition.
