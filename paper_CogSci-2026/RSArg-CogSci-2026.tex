...
As a within-subjects manipulation (high vs.~low framing condition), participants were asked to describe the exam results as either favorable or disfavorable (students did well/poorly, exam was easy/hard).
Each participant saw each of the 20 instances of the same matrix size in completely randomized order.
Trials were randomly assigned to a high or low framing condition, so that each participant saw 10 trials in the high and low framing condition each.
